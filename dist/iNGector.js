...
(function() {
  ...
  iNGector = function() {
    ...
    _executeInitBlocks = function() {
      return new Promise(function(resolve, reject) {
        var _promises, block, d, k, len;
        _promises = [];
        for (k = 0, len = _initBlocks.length; k < len; k++) {
          block = _initBlocks[k];
          _promises.push(block.func.apply(block, (function() {
            var l, len1, ref, results;
    ...
    this.start = function() {
      ...
      return _initPromise.then(_executeProvideBlocks)["catch"](function(error) {
        return console.log("[iNGector] Error runnning configuration blocks: \r\n" + error);
      }).then(_executeInitBlocks)["catch"](function(error) {
        return console.log("[iNGector] Error running init blocks: \r\n" + error);
      }).then(function() {
        _initialized = true;
        return _self;
      });
  ...
  if (typeof window !== "undefined" && window !== null) {
    ...
    module.exports = (function() {
      ...
      iNGector.prototype.preInit = function() {
        return _loadPromise["catch"](function(error) {
          return console.log("[iNGector] Error loading files: \r\n" + error);
        });
      };
      return _di;
    })();
